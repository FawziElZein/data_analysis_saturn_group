CREATE TABLE IF NOT EXISTS target_schema.agg_daily_transactions
(
...
CREATE INDEX IF NOT EXISTS idx_date ON target_schema.agg_daily_transactions(date);
...
INSERT INTO target_schema.agg_daily_transactions
(
    SELECT
