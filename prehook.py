...
from lookups import ErrorHandling, InputTypes,DestinationDatabase,ETLStep,CsvUrlCoinsInfo,CsvUrlTweets,CoinsEnergyConsumption,CsvUrlHistoricalData
...
def execute_prehook(sql_command_directory_path = './SQL_Commands'):
    try:
        ...
        df_sentiment_analysis,df_sentiment_titles = analyze_sentiment(CsvUrlTweets)
