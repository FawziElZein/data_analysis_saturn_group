...
from lookups import ErrorHandling, PreHookSteps, SQLTablesToReplicate, InputTypes, SourceName,DestinationName,ETLStep,CsvUrlTweets,CsvUrlHistoricalData
...
def execute_prehook(sql_command_directory_path = './SQL_Commands'):
    try:
        ...
        df_src_list ,df_src_titles = get_online_csv_into_df_list(CsvUrlTweets,CsvUrlHistoricalData)
